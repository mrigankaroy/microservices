...
public class GatewayEngineController {
    ...
    public @ResponseBody ResponseEntity<RouteEntity> createRoute(
        ...
        routeEntity = zuulRoutingService.addRoute(routeEntity);
        LOGGER.debug("Created {}",routeEntity);
        return getResponse(routeEntity, OK);
    }
    ...
    public @ResponseBody ResponseEntity<Iterable<RouteEntity>> getAllRoute() {
